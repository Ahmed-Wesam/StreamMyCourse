...
def test_api_stack_billing_merchant_status_route_on_catalog() -> None:
    ...
    assert "CatalogApiDeploymentV29:" in text
    deployment_block = text.split("CatalogApiDeploymentV29:")[1].split("CatalogApiStage:")[0]
    ...
    assert "DeploymentId: !Ref CatalogApiDeploymentV29" in text
