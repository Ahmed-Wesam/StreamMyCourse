...
def test_second_checkout_while_incomplete_returns_checkout_in_progress(
    api_base_url: str,
    api: ApiClient,
    student_api: ApiClient,
    course_factory,
    ...
    first = post_checkout_session(student_api, jwt, plan_id=seed_plan_id())
...
def test_checkout_after_lapsed_active_subscription_returns_200(
    api_base_url: str,
    api: ApiClient,
    student_api: ApiClient,
    course_factory,
    ...
    skip_if_mock_ipn_unavailable(restore_resp)
