...
| 6 | **Billing / subscriptions (WS2+)** | In progress — WS1 schema + WS2 payments stack + **WS3 IPN enqueue/fulfillment** ([`plans/billing-subscription-mega-plan.md`](plans/billing-subscription-mega-plan.md)); catalog access gate (WS5) and student checkout (WS6) not yet shipped. |
